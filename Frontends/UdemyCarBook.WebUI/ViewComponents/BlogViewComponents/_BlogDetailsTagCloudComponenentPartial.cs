...
{
    public class _BlogDetailsTagCloudComponenentPartial : ViewComponent
    {
        private readonly ITagCloudConsumeApiService _tagCloudConsumeApiService;
        private readonly IDataProtector _dataProtector;

        public _BlogDetailsTagCloudComponenentPartial(ITagCloudConsumeApiService tagCloudConsumeApiService, IDataProtectionProvider dataProtector)
        {
